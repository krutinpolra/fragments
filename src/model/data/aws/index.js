...
// Delete a fragment's metadata and data from S3 + memory metadata db. Returns a Promise
async function deleteFragment(ownerId, id) {
  ...
  try {
    await s3Client.send(command);
    logger.info({ Bucket: params.Bucket, Key: params.Key }, 'Fragment data deleted from S3');
  } catch (err) {
    logger.error(
  ...
  // Delete metadata from in-memory DB
